...
String.prototype.__indexOf = String.prototype.__indexOf || String.prototype.indexOf;
String.prototype.indexOf = function (searchString) {
    //console.log("字符串：" + this.toString());
    //console.log("查找字符串：" + searchString);
    if (searchString === "native code") {
        return 3;
    }
    return String.prototype.__indexOf.apply(this, arguments);
}
...
XMLHttpRequest = vmProxy(class XMLHttpRequest {
});

v_saf(XMLHttpRequest);
...
CanvasRenderingContext2D = vmProxy(class CanvasRenderingContext2D {
});

CanvasRenderingContext2D.toString = function () {
    return "function CanvasRenderingContext2D() { [native code] }";
}
v_saf(CanvasRenderingContext2D);
...
HTMLDocument = vmProxy(class HTMLDocument {
});
...
HTMLDocument.indexOf = function (name) {
    return this.toString().indexOf(name);
}
...
location.toString = function () {
    return 'https://www.zhihu.com/search?type=content&q=%E4%BC%81%E4%B8%9A%E6%96%87%E5%8C%96';
}

location.href = 'https://www.zhihu.com/search?type=content&q=%E4%B8%AD%E5%9B%BD%E6%8E%92%E5%8D%8F%E5%9B%9E%E5%BA%94%E5%A5%B3%E6%8E%92%E6%88%B4%E5%8F%A3%E7%BD%A9%E6%AF%94%E8%B5%9B';
history = vmProxy(class History {
});
v_saf(history);
...
function o(e) {
    //console.log("param:" + e);
    var result = (o = "function" == typeof Symbol && "symbol" == typeof Symbol.A ? function (e) {
                return typeof e
            }
            : function (e) {
        ...
        try {
            switch (this.T) {
                ...
                case 463:
                    ...
                    break;
                case 465:
                    //console.log("检测位置：", this.C[this.W], "|", Q, "|", G[+[]]);
...
ret = b("9f47e4092ae8682fab357341b985f3d4");
// console.log(ret);

//
// //console.log('a7tB66u0S8NY6_OBsRtyNc9qHhFXnwOBsRYqnvX0k02f');
