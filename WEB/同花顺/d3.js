window = global;
document = {}
document.getElementsByTagName = function getElementsByTagName(name){return name}
document.cookie = 'checkcookie=; expires=Thu, 01 Jan 1970 00:00:00 GMT'
document.createElement = function createElement(tagName){return '<'+tagName+'>'+'</'+tagName+'>'}
...
navigator.javaEnabled = function javaEnabled(){return false}
navigator.plugins = {
    "0": {
        "0": {},
        "1": {}
...
!function (n, t) {
    ...
    !function(n) {
            var t = u[165]
              ...
              , I = s[2]
              , y = s[67]
              , _ = true ? o + G + i : s[172]in c[66] ? u[173] : v + K + f + Q;
